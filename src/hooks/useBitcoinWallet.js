...
const useBitcoinWallet = () => {
    ...
    const signMessage = useCallback(async (message) => {
        ...
        const signedMessage_ = await unisat.signMessage(message, user.address);
    ...
    if(unisat) {
        unisat.on('accountsChanged', (_accounts) => {
    ...
    const handleAccountsChanged = useCallback(async (_accounts) => {
